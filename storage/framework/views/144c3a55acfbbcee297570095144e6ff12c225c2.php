            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        <?php if(auth('admin')->user()->can('permission.add')): ?>
                        <a href="<?php echo e(url('admin/permission/create')); ?>">
...
<?php $__env->startSection('admin-js'); ?>
    ...
    <script src="<?php echo e(asset('asset_admin/js/permission.list.js')); ?>"></script>
    <script>
        $(function(){
