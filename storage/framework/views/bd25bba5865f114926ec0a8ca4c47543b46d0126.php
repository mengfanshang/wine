    	...
    	<div class="container">
            ...
            <div class="nav">
            	<ul>
                    ...
                    <li class="active"><a href="<?php echo e(route('index.service')); ?>">售后服务</a></li>
...
<!--左侧-->
	<div class="xq-left">
    	<div class="left-menu">
        	<div class="left-title">售后服务</div>
            <ul>
            	<li class="onm"><a href="#" title="售后服务"><i></i>售后服务</a></li>
            </ul>
        </div>
...
<div class="xq-right">
	<div class="right-title">
    	<span class="fl">售后服务</span><em class="fr">首页> 售后服务</em>
    </div>
    <div class="clear"></div>
