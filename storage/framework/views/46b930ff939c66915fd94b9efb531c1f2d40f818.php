    	...
    	<div class="container">
            ...
            <div class="nav">
            	<ul>
                    ...
                    <li class="active"><a href="<?php echo e(route('index.person')); ?>">人才招聘</a></li>
...
<!--左侧-->
	<div class="xq-left">
    	<div class="left-menu">
        	<div class="left-title">人才招聘</div>
            <ul>
            	<li class="onm"><a href="#" title="人才招聘"><i></i>人才招聘</a></li>
            </ul>
        </div>
...
<div class="xq-right">
	<div class="right-title">
    	<span class="fl">人才招聘</span><em class="fr">首页> 人才招聘</em>
    </div>
    <div class="clear"></div>
